# Durham Chemistry Thesis Template

The below is the README.md of the template I found. I will update the below later...
...
Most of the weight of the thesis options are hidden in the `durchem.cls` class
file, which is used by calling `\documentclass{durchem}` at the top of your
